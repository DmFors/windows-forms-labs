namespace lab_6_fill
{
    public partial class MainForm : Form
    {
        ...
        private void pictureBox1_MouseClick(object sender, MouseEventArgs e) // клик по области рисовани€ дл€ выбора точки затравки
        {
        ...
        private void SetInfoText(string text) // уведомлени€ дл€ пользовател€
        {
            infoLabel.Text = text;
            Refresh();
        }
